...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(448, 15);
			this->label1->TabIndex = 0;
			this->label1->Text = L"8. Створити чергу цілих чисел. Обчислити суму елементів черги, які менші 5.";
			// 
			// label2
			// 
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(169, 90);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(205, 146);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(205, 204);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(205, 258);
			...
			this->listBox1->Location = System::Drawing::Point(53, 146);
			...
			this->pictureBox1->Location = System::Drawing::Point(326, 123);
			this->pictureBox1->Name = L"pictureBox1";
			this->pictureBox1->Size = System::Drawing::Size(285, 211);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e)
	{
		...
		{
			String^ valueInput = Microsoft::VisualBasic::Interaction::InputBox("Введіть ціле число:", "Додавання елемента", "0");
			if (valueInput == "")
			{
				return;
			}
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	MessageBox::Show("Сума елементів черги, які менші 5: "+sum.ToString());
}
